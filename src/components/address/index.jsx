    ...
    return(
       <>
            <section className='flex flex-column py-3 h-full justify-content-between'>
                <div>
                    <div>
                        <h2 className=' font-semibold'>{LABEL.ADDRESS}</h2>
                    </div>
                    <div className='pt-2'>
                        <p className=' text-color-secondary max-w-12rem'>Rua Serra da Mantiqueira 78 Jardim Planalto Carapicuíba, SP</p>
                    </div>
                </div>
                <div>
            ...
            <section className='bumblebee__container_modal'>
                <Dialog header={LABEL.EDIT_MY_ADDRESS} 
                    ...
                    <section className='flex lg:px-3 pt-1'>
                        <p className=' text-color-secondary lg:max-w-12rem text-left'>Rua Serra da Mantiqueira 78 Jardim Planalto Carapicuíba, SP</p>
                    </section>
                        ...
                        <form className="p-fluid w-full" onSubmit={formik.handleSubmit}>
                            <section className='flex flex-column lg:flex-row gap-5'>
                                <div className="w-full lg:max-w-12rem">
                                    <label className='text-color-secondary' htmlFor="cep">{LABEL.CEP}</label>
                                    <InputText 
                                        id="cep" 
                                        name="cep"
                                        type="text"
                            ...
                            <section className='flex flex-column lg:flex-row gap-5 pt-3'>
                                <div className="w-full">
                                    <label className='text-color-secondary' htmlFor="street">{LABEL.STREET}</label>
                                    <InputText 
                                        id="street" 
                                        name="street"
                                        type="text"
                            ...
                            <section className='flex flex-column lg:flex-row gap-5 pt-3'>
                                <div className="w-full lg:max-w-12rem">
                                    <label className='text-color-secondary' htmlFor="number">{LABEL.NUMBER}</label>
                                    <InputText 
                                        id="number" 
                                        name="number"
                                        type="text"
                                ...
                                <div className="w-full">
                                    <label className='text-color-secondary' htmlFor="complement">{LABEL.COMPLEMENT}</label>
                                    <InputText 
                                        id="complement" 
                                        name="complement"
                                        type="text"
                            ...
                            <section className='flex flex-column lg:flex-row gap-5 pt-3'>
                                <div className="w-full">
                                    <label className='text-color-secondary' htmlFor="neighborhood">{LABEL.NEIGHBORHOOD}</label>
                                    <InputText 
                                        id="neighborhood" 
                                        name="neighborhood"
                                        type="text"
                            ...
                            <section className='flex flex-column lg:flex-row gap-5 pt-3'>
                                <div className="w-full">
                                    <label className='text-color-secondary' htmlFor="city">{LABEL.CITY}</label>
                                    <InputText 
                                        id="city" 
                                        name="city"
                                        type="text"
                                ...
                                <div className="w-full lg:max-w-12rem">
                                    <label className='text-color-secondary' htmlFor="state">{LABEL.STATE}</label>
                                    <InputText 
                                        id="state" 
                                        name="state"
                                        type="text"
                            ...
                            <section className='pt-6 flex justify-content-end'>
